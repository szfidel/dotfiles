...
user_pref("media.peerconnection.enabled", true); // Used to disable WebRTC (mitigating WebRTC leaks)… set to `true` to enable WebRTC
...
user_pref("security.cert_pinning.enforcement_level", 1); //It was in 2 I'm changing in to 1 for YouTube to work
